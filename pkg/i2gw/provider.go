...
type ProviderConf struct {
	...
	NotificationAgg       *notifications.NotificationAggregator
}
...
type FeatureParser func([]networkingv1.Ingress, map[types.NamespacedName]map[string]int32, *providerir.ProviderIR, *notifications.Notifier) field.ErrorList
