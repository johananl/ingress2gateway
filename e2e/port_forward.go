...
// PortForwarder manages a port-forward connection to a Kubernetes pod using client-go.
...
// StartPortForwardToService creates a port-forward to a service's backing pod using client-go.
...
// FindGatewayService finds the service created by a Gateway API implementation for a Gateway object.
...
// FindIngressControllerService finds the service for an ingress controller.
